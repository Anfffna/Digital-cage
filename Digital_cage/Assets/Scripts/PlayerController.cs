...
public class PlayerController : MonoBehaviour
{
    ...
    public bool canMove = true; // флаг, блокирующий движение, но камера остаЄтс€ активной
    public bool lockVerticalLook = false; // если true Ч нельз€ крутить камеру по X
    void Start()
    {
    ...
    void Update()
    {
        ...
        HandleMouseLook();   //  амера работает всегда
        HandleMovement();    // ƒвижение может быть заблокировано
        HandleFootsteps();
    }

    void HandleGravityAndGrounded()
    {
        if (!canMove)  // если сидим, гравитаци€ не нужна
        {
    ...
    void HandleMouseLook()
    {
        ...
        if (restrictHorizontalLook)
        {
            ...
            // преобразуем в -180..180 дл€ корректного ограничени€
    ...
    void HandleMovement()
    {
        if (!canMove) return; // если игрок сидит, движение блокируетс€, камера работает
    ...
    // ƒќЅј¬Ћ≈ЌЌџ≈ ћ≈“ќƒџ ƒЋя ¬«ј»ћќƒ≈…—“¬»я —ќ —“”Ћќћ
    public void OnSitDown()
{
    ...
    Debug.Log("»грок сел на стул - движение заблокировано");
}
    ...
    public void OnStandUp()
    {
        ...
        Debug.Log("»грок встал со стула - движение разблокировано");
    }

    /// <summary>
    /// ∆Єстко сбрасывает только вертикальную скорость,
    /// чтобы при вставании не было подлЄтов или рывков.
    /// </summary>
    public void ResetVerticalVelocity()
{
    ...
    // ======= ѕ”ЅЋ»„Ќќ≈ —¬ќ…—“¬ќ ƒЋя ”ѕ–ј¬Ћ≈Ќ»я ¬≈–“» јЋ№Ќџћ ”√Ћќћ  јћ≈–џ =======
