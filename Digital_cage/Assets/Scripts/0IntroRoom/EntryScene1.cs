...
public class EntryScene1 : MonoBehaviour
{
    ...
    private IEnumerator SceneStartSequence()
    {
        ...
        if (blackScreenImage != null)
        {
            ...
            Debug.Log("EntryScene1: Черный экран активирован");
        }
        ...
        if (cursorManager != null)
        {
            ...
            Debug.Log("EntryScene1: Курсор выключен");
        ...
        {
            Debug.LogError("EntryScene1: CursorUI не найден!");
        }
        ...
        Debug.Log("EntryScene1: Сцена инициализирована");
    }
    ...
    private IEnumerator ForceHideCursor()
    {
        ...
        {
            cursorManager.HideCursor();
            Debug.Log("EntryScene1: Курсор принудительно выключен повторно");
        }
    }
    ...
    private IEnumerator FadeOutBlackScreen()
    {
        ...
        if (blackScreenImage != null) // Финальная защита
        {
            ...
            Debug.Log("EntryScene1: Черный экран скрыт");
        }
    }
