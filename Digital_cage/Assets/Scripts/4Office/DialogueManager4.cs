...
public class DialogueManager4 : MonoBehaviour
{
    ...
    public ToDoUI todoManager; // Ссылка на менеджер туду
    ...
    void Awake()
    {
        ...
        if (dialoguePanel != null)
            ...
            Debug.LogError("DialogueManager4: dialoguePanel не назначен в инспекторе!");
    }
    ...
    {
        Debug.Log($"DialogueManager4: StartDialogue вызван, строк: {dialogueLines?.Count}");

        if (lines == null)
        {
            Debug.LogError("DialogueManager4: lines is NULL! Инициализирую экстренно...");
            lines = new Queue<string>();
        }
        ...
        if (dialoguePanel != null)
            ...
            Debug.LogError("DialogueManager4: dialoguePanel is NULL!");
    ...
    public void DisplayNextLine()
    {
        ...
        if (lines == null)
        {
            Debug.LogError("DialogueManager4: lines is NULL in DisplayNextLine!");
            return;
        }
    ...
    private void CheckForTodoTrigger()
    {
        ...
        {
            Debug.Log($"DialogueManager4: Показываем Todo после строки {showTodoAfterLine}");
