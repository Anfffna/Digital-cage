...
public class ManagerDialogue3 : MonoBehaviour
{
    ...
    public LightTodoUIManager todoManager; // Ссылка на менеджер туду для включения света
    ...
    void Awake()
    {
        ...
        if (dialoguePanel != null)
            ...
            Debug.LogError("ManagerDialogue3: dialoguePanel не назначен в инспекторе!");
    }
    ...
    {
        Debug.Log($"ManagerDialogue3: StartDialogue вызван, строк: {dialogueLines?.Count}");

        if (lines == null)
        {
            Debug.LogError("ManagerDialogue3: lines is NULL! Инициализирую экстренно...");
            lines = new Queue<string>();
        }
        ...
        if (dialoguePanel != null)
            ...
            Debug.LogError("ManagerDialogue3: dialoguePanel is NULL!");
    ...
    public void DisplayNextLine()
    {
        ...
        if (lines == null)
        {
            Debug.LogError("ManagerDialogue3: lines is NULL in DisplayNextLine!");
            return;
        }
    ...
    private void CheckForTodoTrigger()
    {
        ...
        {
            Debug.Log($"ManagerDialogue3: Показываем Todo после строки {showTodoAfterLine}");
